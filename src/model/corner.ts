...
module BP3D.Model {
	...
	*/
	export class Corner {
		...
		private drag_x : number;
		private drag_y : number;
		...
		*/
		public relativeMove(dx: number, dy: number, merge: boolean = true) {
		...
		*/
		private move(newX: number, newY: number, merge: boolean = true) {
			this.x = newX;
			this.y = newY;
