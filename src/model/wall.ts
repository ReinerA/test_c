...
module BP3D.Model {
	...
	*/
	export class Wall {
		...
		public frontTexture : Items.TextureData;

		/** The back-side texture. */
		public backTexture : Items.TextureData;
		...
		*/
		constructor(private start: Corner, private end: Corner,defaultWallTexture: Items.TextureData) {
