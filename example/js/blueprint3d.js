        ...
        */
        var Item = (function (_super) {
            ...
            */
            ...
            ;
            /** */
            Item.prototype.startRotate = function (intersection) {
                this.angleOffset = Math.atan2(intersection.point.x - this.position.x, intersection.point.z - this.position.z) - this.rotation.y;
            };
            ;
            /** */
            ...
            Item.prototype.rotate = function (intersection) {
                if (intersection) {
                    ...
                    var angle = Math.atan2(intersection.point.x - this.position.x, intersection.point.z - this.position.z) - this.angleOffset;
    ...
    (function (Model) {
        ...
        */
        var Corner = (function () {
            ...
            */
            Corner.prototype.relativeMove = function (dx, dy, merge) {
                if (merge === void 0) { merge = true; }
                this.drag_x += dx;
                this.drag_y += dy;
                this.move(this.drag_x, this.drag_y, merge);
            };
            Corner.prototype.clickPressed = function () {
                this.drag_x = this.x;
                this.drag_y = this.y;
            };
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var HalfEdge = (function () {
             ...
             *
             */
            HalfEdge.prototype.setTexture = function (textureUrl, textureStretch, textureScale, item_Id) {
                var texture = {
                    url: textureUrl,
    ...
    (function (Model) {
        ...
        */
        var Wall = (function () {
            ...
            */
            function Wall(start, end, defaultWallTexture) {
                this.start = start;
                this.end = end;
    ...
    (function (Model) {
        ...
        */
        var Room = (function () {
            ...
            *  ordered CCW
            */
            function Room(floorplan, corners, defaultRoomTexture, defaultRoofTexture) {
                this.floorplan = floorplan;
                this.corners = corners;
                this.defaultRoomTexture = defaultRoomTexture;
                this.defaultRoofTexture = defaultRoofTexture;
                /** */
                ...
                /** */
                this.roofChangeCallbacks = $.Callbacks();
                this.updateWalls();
                this.updateInteriorCorners();
                this.generateFloorPlane();
                this.roof = new Model.Roof(this);
            ...
            Room.prototype.fireOnRoofChange = function (callback) {
                this.roofChangeCallbacks.add(callback);
            };
            Room.prototype.getTexture = function () {
                var uuid = this.getUuid();
                var tex = this.floorplan.getFloorTexture(uuid);
                return tex || this.defaultRoomTexture;
            };
            /**
            * textureStretch always true, just an argument for consistency with walls
            */
            Room.prototype.setTexture = function (textureUrl, textureStretch, textureScale, item_Id) {
                var uuid = this.getUuid();
                this.floorplan.setFloorTexture(uuid, textureUrl, textureScale, item_Id);
                this.floorChangeCallbacks.fire();
            };
            Room.prototype.getRoofTexture = function () {
                var uuid = this.getUuid();
                var tex = this.floorplan.getRoofTexture(uuid);
                return tex || this.defaultRoofTexture;
            };
            Room.prototype.setRoofTexture = function (textureUrl, textureStretch, textureScale, item_Id) {
                var uuid = this.getUuid();
                this.floorplan.setRoofTexture(uuid, textureUrl, textureScale, item_Id);
                this.roofChangeCallbacks.fire();
            };
            Room.prototype.generateFloorPlane = function () {
                var points = [];
            ...
            Room.prototype.generateRoofPlane = function () {
                var WallHeight = BP3D.Core.Configuration.getNumericValue(BP3D.Core.configWallHeight);
                var points = [];
                this.interiorCorners.forEach(function (corner) {
                    points.push(new THREE.Vector2(corner.x, corner.y));
                });
                var shape = new THREE.Shape(points);
                var geometry = new THREE.ShapeGeometry(shape);
                this.roofPlane = new THREE.Mesh(geometry, new THREE.MeshBasicMaterial({
                    side: THREE.DoubleSide
                }));
                this.roofPlane.visible = false;
                this.roofPlane.rotation.set(Math.PI / 2, 0, 0);
                this.roofPlane.position.y = WallHeight;
                this.roofPlane.roof = this.roof; // js monkey patch
            };
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var Floorplan = (function () {
            ...
            function Floorplan(defaultWallTexture, defaultRoomTexture, defaultRoofTexture) {
                this.defaultWallTexture = defaultWallTexture;
                this.defaultRoomTexture = defaultRoomTexture;
                this.defaultRoofTexture = defaultRoofTexture;
                /** */
                this.walls = [];
            ...
            Floorplan.prototype.roofPlanes = function () {
                return BP3D.Core.Utils.map(this.rooms, function (room) {
                    return room.roofPlane;
                });
            };
            ...
            Floorplan.prototype.newWall = function (start, end) {
                var wall = new Model.Wall(start, end, this.defaultWallTexture);
            ...
            Floorplan.prototype.overlappedCornerOrWall = function (x, y, cornerRadius, wallWidth) {
                var result = null;
                var mn = cornerRadius;
                for (var i = 0; i < this.corners.length; i++) {
                    var corners = this.corners[i];
                    var dist = corners.distanceFrom(x, y);
                    if (dist < mn) {
                        mn = dist;
                        result = corners;
                    }
                }
                mn = Math.min(mn, wallWidth);
                for (var i = 0; i < this.walls.length; i++) {
                    var wall = this.walls[i];
                    var dist = wall.distanceFrom(x, y);
                    if (dist < mn) {
                        mn = dist;
                        result = wall;
                    }
            ...
            Floorplan.prototype.saveFloorplan = function () {
                ...
                floorplan.newRoofTextures = this.roofTextures;
                return floorplan;
            };
            Floorplan.prototype.loadFloorplan = function (floorplan) {
                ...
                if ('newRoofTextures' in floorplan) {
                    this.roofTextures = floorplan.newRoofTextures;
                }
                this.update();
            ...
            Floorplan.prototype.setFloorTexture = function (uuid, url, scale, item_Id) {
            ...
            Floorplan.prototype.getRoofTexture = function (uuid) {
                if (uuid in this.roofTextures) {
                    return this.roofTextures[uuid];
                }
                else {
                    return null;
                }
            };
            Floorplan.prototype.setRoofTexture = function (uuid, url, scale, item_Id) {
                this.roofTextures[uuid] = {
                    url: url,
                    scale: scale,
                    item_Id: item_Id
                };
            ...
            Floorplan.prototype.update = function () {
                ...
                roomCorners.forEach(function (corners) {
                    scope.rooms.push(new Model.Room(scope, corners, scope.defaultRoomTexture, scope.defaultRoofTexture));
                });
        ...
        */
        var Scene = (function () {
            ...
            */
            ...
            Scene.prototype.changeItem = function (item, itemType, modelUrl, metadata) {
                var scope = this;
                var old_position = item.position;
                item.remove();
                this.addItem(itemType, modelUrl, metadata, old_position, null, null, null);
                function add(item) {
                    item.position_set = false;
                    item.placeInRoom();
                    item.position.x = old_position.x;
                    item.position.z = old_position.z;
                    scope.itemLoadedCallbacks.remove(add);
                }
                this.itemLoadedCallbacks.add(add);
                item.position.x = old_position.x;
                item.position.z = old_position.z;
            };
            return Scene;
    ...
    (function (Model_1) {
        ...
        */
        var Model = (function () {
            ...
            */
            function Model(textureDir, defaultRoomTexture, defaultWallTexture, defaultRoofTexture) {
                /** */
                ...
                this.floorplan = new Model_1.Floorplan(defaultWallTexture, defaultRoomTexture, defaultRoofTexture);
...
(function (BP3D) {
    ...
    (function (Floorplanner) {
        ...
        // corner config
        var cornerRadiusCm = 0;
        var cornerRadiusHoverCm = 12;
        ...
        var FloorplannerView = (function () {
            ...
            FloorplannerView.prototype.drawWall = function (wall) {
                ...
                this.drawLine(this.viewmodel.convertX(wall.getStartX()), this.viewmodel.convertY(wall.getStartY()), this.viewmodel.convertX(wall.getEndX()), this.viewmodel.convertY(wall.getEndY()), (hover ? wallWidthHoverCm : wallWidthCm) * this.viewmodel.pixelsPerCm, color);
            ...
            FloorplannerView.prototype.drawCorner = function (corner) {
                ...
                this.drawCircle(this.viewmodel.convertX(corner.x), this.viewmodel.convertY(corner.y), (hover ? cornerRadiusHoverCm : cornerRadiusCm) * this.viewmodel.pixelsPerCm, color);
            };
            /** */
            FloorplannerView.prototype.drawTarget = function (x, y, lastNode) {
                this.drawCircle(this.viewmodel.convertX(x), this.viewmodel.convertY(y), cornerRadiusHoverCm * this.viewmodel.pixelsPerCm, cornerColorHover);
                if (this.viewmodel.lastNode) {
                    this.drawLine(this.viewmodel.convertX(lastNode.x), this.viewmodel.convertY(lastNode.y), this.viewmodel.convertX(x), this.viewmodel.convertY(y), wallWidthHoverCm * this.viewmodel.pixelsPerCm, wallColorHover);
                }
            };
            /** */
            ...
            FloorplannerView.prototype.calculateGridOffset = function (n, gridSpacing) {
                if (n >= 0) {
            ...
            FloorplannerView.prototype.drawGrid = function () {
                var gridSpacing = gridSpacingCm * this.viewmodel.pixelsPerCm;
    ...
    (function (Floorplanner_1) {
        ...
        */
        var Floorplanner = (function () {
            function Floorplanner(element, canvas, floorplan) {
                this.floorplan = floorplan;
                /** */
                this.mode = 0;
                /** */
                ...
                this.lastNode = null;
                /** */
                this.SelectedCallbacks = $.Callbacks();
                /** */
                this.UnselectedCallbacks = $.Callbacks();
                /** */
                this.MovedCallbacks = $.Callbacks();
                /** */
            ...
            Floorplanner.prototype.RatioUpdata = function () {
                var cmPerFoot = 30.48;
            ...
            Floorplanner.prototype.ZoomAdd = function (value, cx, cy) {
                var max_zoom = 5.0;
                var min_zoom = 0.5;
            ...
            Floorplanner.prototype.ZoomIn = function (zoom) {
                if (zoom === void 0) { zoom = 1.2; }
                this.ZoomAdd(1 / zoom, this.rawMouseX, this.rawMouseY);
            };
            ;
            Floorplanner.prototype.ZoomOut = function (zoom) {
                if (zoom === void 0) { zoom = 1.2; }
                this.ZoomAdd(1 * zoom, this.rawMouseX, this.rawMouseY);
            };
            ;
            ...
            Floorplanner.prototype.updateTarget = function () {
                if ((this.mode == Floorplanner_1.floorplannerModes.DRAW || this.mode == Floorplanner_1.floorplannerModes.DRAWTOUCH) && this.lastNode) {
            ...
            //mobile
            Floorplanner.prototype.removeActiveWall = function () {
                if (this.activeWall) {
            ...
            Floorplanner.prototype.PossTouches = function (touches) {
                var poss = [];
            ...
            Floorplanner.prototype.distPoss = function (poss) {
                var dx = poss[0].x - poss[1].x;
                var dy = poss[0].y - poss[1].y;
                return Math.sqrt((dx * dx) + (dy * dy));
            };
            Floorplanner.prototype.touchstart = function (event) {
                event.preventDefault();
                this.mouseDown = true;
                this.mouseMoved = false;
                switch (event.originalEvent.touches.length) {
                    case 1:
                        ...
                        if (this.mode == Floorplanner_1.floorplannerModes.DRAWTOUCH || (this.mode == Floorplanner_1.floorplannerModes.MOVE && this.mouseDown)) {
                            this.updateTarget();
                        }
                        var RadiusCm = 12;
                        var wallWidthCm = 5;
                        // update object target
                        if (this.mode != Floorplanner_1.floorplannerModes.DRAWTOUCH) {
                            ...
                            else if (target instanceof BP3D.Model.Wall) {
                                hoverWall = target;
                            }
                            var draw = false;
                            ...
                            if (!corner1)
                                corner1 = this.floorplan.newCorner(this.targetX, this.targetY);
                        ...
                        if (old_selected !== selected) {
                            if (old_selected !== null)
                                this.UnselectedCallbacks.fire(old_selected);
                            if (selected !== null)
                                this.SelectedCallbacks.fire(selected);
                        }
            ...
            Floorplanner.prototype.touchmove = function (event) {
                ...
                switch (event.originalEvent.touches.length) {
                    case 1:
                        ...
                        // dragging
                        if (this.mode !== Floorplanner_1.floorplannerModes.DELETE && this.mouseDown) {
                            if (this.activeCorner) {
                                this.activeCorner.relativeMove((this.rawMouseX - this.lastX) * this.cmPerPixel, (this.rawMouseY - this.lastY) * this.cmPerPixel, this.mode !== Floorplanner_1.floorplannerModes.DRAWTOUCH);
                        ...
                        break;
                    case 2:
                        var touches_poss = this.PossTouches(event.originalEvent.touches);
                        var dist = this.distPoss(touches_poss);
                        var last_dist = this.distPoss(this.last_touches_poss);
                        var sx = (touches_poss[0].x - touches_poss[1].x) - (this.last_touches_poss[0].x - this.last_touches_poss[1].x);
                        var sy = (touches_poss[0].y - touches_poss[1].y) - (this.last_touches_poss[0].y - this.last_touches_poss[1].y);
                        var zx = (1 / this.element.innerWidth()) * Math.abs(sx);
                        var zy = (1 / this.element.innerHeight()) * Math.abs(sy);
                        var mx = Math.max(zx, zy);
                        var cx = touches_poss[0].x + (touches_poss[1].x - touches_poss[0].x) * 0.5;
                        var cy = touches_poss[0].y + (touches_poss[1].y - touches_poss[0].y) * 0.5;
                        this.ZoomAdd((last_dist > dist) ? 1 - mx : 1 + mx, cx, cy);
                        this.last_touches_poss = touches_poss;
                        break;
                }
            };
            Floorplanner.prototype.touchend = function (event) {
                event.preventDefault();
                this.mouseDown = false;
                if (this.mode == Floorplanner_1.floorplannerModes.DRAWTOUCH && this.activeCorner && this.activeWall) {
                    this.activeCorner.mergeWithIntersected();
                    var dist = this.activeWall.frontEdge.interiorDistance();
            ...
            Floorplanner.prototype.LoadTemplate = function (floorplan) {
                this.floorplan.loadFloorplan(floorplan);
            };
            Floorplanner.prototype.SaveTemplate = function (callback) {
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Controller = function (three, model, camera, element, controls, hud) {
            ...
            function init() {
                element.on("touchstart  mousedown", mouseDownEvent);
                element.on("touchend mouseup", mouseUpEvent);
                element.on("touchmove mousemove", mouseMoveEvent);
            ...
            function startRotate(vec2) {
                vec2 = vec2 || mouse;
                var intersection = scope.itemIntersection(mouse, selectedObject);
                if (intersection) {
                    selectedObject.startRotate(intersection);
                }
            }
            ...
            function checkWallsAndFloorsAndRoof(event) {
                ...
                if (state == states.UNSELECTED && mouseoverObject == null) {
                    ...
                    // check roofs
                    var roofPlanes = model.floorplan.roofPlanes();
                    var roofIntersects = scope.getIntersections(mouse, roofPlanes, false);
                    if (roofIntersects.length > 0) {
                        var roof = roofIntersects[0].object.roof;
                        three.roofClicked.fire(roof);
                        return;
                    }
            ...
            function mouseMoveEvent(event) {
                if (scope.enabled) {
                    ...
                    if (event.type == "touchmove") {
                        ...
                        mouse.x = touch.clientX - element.offset().left;
                        mouse.y = touch.clientY - element.offset().top;
                    }
                    else {
                        mouse.x = event.clientX - element.offset().left;
                        mouse.y = event.clientY - element.offset().top;
                    }
                    if (!mouseDown) {
                        updateIntersections();
                    }
                    switch (state) {
                        ...
                        case states.ROTATING_FREE:
                            clickDragged();
                            hud.update();
                            three.itemMovedCallbacks.fire(selectedObject);
            ...
            this.onItemRotate = function (event) {
                event.preventDefault();
                if (event.type == "touchstart") {
                    var touch = event.originalEvent.touches[0] || event.originalEvent.changedTouches[0];
                    mouse.x = touch.clientX - element.offset().left;
            ...
            function normalizeVector2(vec2) {
                ...
                retVec.x = (vec2.x / three.elementWidth) * 2 - 1;
                retVec.y = -(vec2.y / three.elementHeight) * 2 + 1;
...
(function (BP3D) {
    var Three;
    (function (Three) {
        Three.Floor = function (scene, room, controls) {
            var scope = this;
            this.room = room;
    ...
    (function (Three) {
        Three.Floorplan = function (scene, floorplan, controls) {
            ...
            function redraw() {
                ...
                scope.roofs.forEach(function (roof) {
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Controls = function (object, domElement) {
            ...
            this.maxPolarAngle = Math.PI / 1.7; // radians
        ...
        */
        Three.HUD = function (three) {
            ...
            function rotateVector(item) {
                var vec = new THREE.Vector3(0, 0, Math.max(item.halfSize.x, item.halfSize.z) + 5.4 + distance);
                return vec;
            }
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Main = function (model, element, canvasElement, opts) {
            ...
            this.itemMovedCallbacks = $.Callbacks();
            this.wallClicked = $.Callbacks(); // wall
            this.floorClicked = $.Callbacks(); // floor
            this.roofClicked = $.Callbacks(); // roof
            ...
            this.updateWindowSize = function (Height) {
                ...
                if (Height) {
                    camera.setViewOffset(scope.elementWidth, Height, 0, 0, scope.elementWidth, scope.elementHeight);
                }
...
(function (BP3D) {
    ...
    var Blueprint3d = (function () {
        ...
        function Blueprint3d(options) {
            this.model = new BP3D.Model.Model(options.textureDir, options.defaultRoomTexture, options.defaultWallTexture, options.defaultRoofTexture);
            this.three = new BP3D.Three.Main(this.model, options.threeElement, options.threeCanvasElement, {});
            if (!options.widget) {
                this.floorplanner = new BP3D.Floorplanner.Floorplanner(options.floorplannerElement, options.floorplannerCanvasElement, this.model.floorplan);
            }
            else {
...
(function (BP3D) {
    ...
    (function (Items) {
        var WallHeight = BP3D.Core.Configuration.getNumericValue(BP3D.Core.configWallHeight);
        var RoofItem = (function (_super) {
            __extends(RoofItem, _super);
            ...
            ;
            RoofItem.prototype.removed = function () {
                this.model.scene.remove(this.plane);
            };
            RoofItem.prototype.buildPlane = function () {
                var size = 10000;
                var plane = new THREE.Mesh(new THREE.PlaneGeometry(size, size), new THREE.MeshBasicMaterial({ side: THREE.DoubleSide }));
                plane.rotation.x = -Math.PI / 2;
                plane.position.y = WallHeight;
                plane.visible = false;
                return plane;
            };
            RoofItem.prototype.customIntersectionPlanes = function () {
                return [this.plane];
            };
            /** */
...
(function (BP3D) {
    ...
    (function (Items) {
        ...
        var OnRoofItem = (function (_super) {
            ...
            function OnRoofItem(model, metadata, geometry, material, position, rotation, scale) {
                _super.call(this, model, metadata, geometry, material, position, rotation, scale);
            }
            ;
            return OnRoofItem;
...
(function (BP3D) {
    ...
    (function (Model) {
        var Roof = (function () {
            ...
            Roof.prototype.getTexture = function () {
                return this.room.getRoofTexture();
            };
            Roof.prototype.setTexture = function (textureUrl, textureStretch, textureScale, item_Id) {
...
(function (BP3D) {
    var Three;
    (function (Three) {
        Three.Roof = function (scene, room, controls) {
            var WallHeight = BP3D.Core.Configuration.getNumericValue(BP3D.Core.configWallHeight);
            var scope = this;
            this.room = room;
            ...
            function updateVisibility() {
                ...
                normal.normalize();
                var position = controls.object.position.clone();
                var focus = new THREE.Vector3(0, WallHeight, 0);
                var direction = position.sub(focus).normalize();
                var dot = normal.dot(direction);
                var visible = (dot > 0);
